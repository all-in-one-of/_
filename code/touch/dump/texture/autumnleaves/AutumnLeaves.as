package avdw.texture.autumnleaves {
	 ...
	 */
	public class AutumnLeaves implements ITexture {
		[Embed(source="photosculpt-autumnleaves-diffuse.jpg")]
		private static const Diffuse:Class;
		[Embed(source="photosculpt-autumnleaves-normal.jpg")]
		private static const Normal:Class;
		[Embed(source="photosculpt-autumnleaves-detail.jpg")]
		private static const Detail:Class;
		
		public static const _name:String = "Autumn Leaves";
		public static const instance:ITexture = new AutumnLeaves();
