package avdw.texture.pebbles {
	 ...
	 */
	public class Pebbles implements ITexture {
		[Embed(source="photosculpt-pebbles-diffuse.jpg")]
		private static const Diffuse:Class;
		[Embed(source="photosculpt-pebbles-normal.jpg")]
		private static const Normal:Class;
		[Embed(source="photosculpt-pebbles-detail.jpg")]
		private static const Detail:Class;
		
		public static const _name:String = "Pebbles";
		public static const instance:ITexture = new Pebbles();
