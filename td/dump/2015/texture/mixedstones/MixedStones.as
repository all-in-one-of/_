package avdw.texture.mixedstones {
	 ...
	 */
	public class MixedStones implements ITexture {
		[Embed(source="photosculpt-mixedstones-diffuse.jpg")]
		private static const Diffuse:Class;
		[Embed(source="photosculpt-mixedstones-normal.jpg")]
		private static const Normal:Class;
		[Embed(source="photosculpt-mixedstones-detail.jpg")]
		private static const Detail:Class;
		
		public static const _name:String = "Mixed Stones";
		public static const instance:ITexture = new MixedStones();
