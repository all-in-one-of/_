package avdw.texture.horizontalstone {
	 ...
	 */
	public class HorizontalStone implements ITexture {
		[Embed(source="photosculpt-horizontalstone-diffuse.jpg")]
		private static const Diffuse:Class;
		[Embed(source="photosculpt-horizontalstone-normal.jpg")]
		private static const Normal:Class;
		[Embed(source="photosculpt-horizontalstone-detail.jpg")]
		private static const Detail:Class;
		
		public static const _name:String = "Horizontal Stone";
		public static const instance:ITexture = new HorizontalStone();
